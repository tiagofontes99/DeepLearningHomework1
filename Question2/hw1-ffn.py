...
def main():
    ...
    for ii in epochs:
        ...
        for X_batch, y_batch in train_dataloader:
            ...
            epoch_train_losses.append(loss)                     # append loss for each batch, to then obtain the loss of the epoch

        model.eval()
        epoch_train_loss = torch.tensor(epoch_train_losses).mean().item()     # average loss of the epoch
